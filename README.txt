...
* You should start using the simple new Wordpress TinyMCE editor plugin to build numerous variation of shortcodes from your portfolio with ease. This version include responsive improvements.